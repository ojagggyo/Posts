...
function donokuraimae(date){
	...
	var now = new Date();
	sa = now - date1;
	if(sa >= 31556925130*2){return Math.floor(sa / 31556925130)+' earths';}//365.242189*3600*24*1000
	if(sa >= 2360591558*2){return Math.floor(sa / 2360591558)+' moons';}//27.32166155*3600*24*1000
	if(sa >= 86400000*2){return Math.floor(sa / 86400000)+' days';}
	if(sa >= 3600000*2){return Math.floor(sa / 3600000)+' hours';}
	if(sa >= 60000*2){return Math.floor(sa / 60000)+' minutes';}
	if(sa >= 1000*2){return Math.floor(sa / 1000)+' seconds';}
	return 'just now';
}
